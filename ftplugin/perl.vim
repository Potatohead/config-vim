...
" Now that the perlpath is set we have a problem where the completefunc takes
" forever to search completion as it scans the entire perl path so we remove the
" included files from complete searching
setlocal complete-=i

let &l:path=perlpath
"---------------------------------------------
"
" perl-support plugin added in here
" Vim filetype plugin file
"
"   Language :  Perl
...
if !exists("g:Perl_NoKeyMappings") || ( exists("g:Perl_NoKeyMappings") && g:Perl_NoKeyMappings!=1 )
  ...
  " ----------------------------------------------------------------------------
  "
  "possible problem here with writing some code and this stuff taking over
  nnoremap    <buffer>  <silent>  <LocalLeader>i$         :call Perl_InsertTemplate("idioms.scalar")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>i$=        :call Perl_InsertTemplate("idioms.scalar-assign")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>i$$        :call Perl_InsertTemplate("idioms.scalar2")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>i@         :call Perl_InsertTemplate("idioms.array")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>i@=        :call Perl_InsertTemplate("idioms.array-assign")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>i%         :call Perl_InsertTemplate("idioms.hash")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>i%=        :call Perl_InsertTemplate("idioms.hash-assign")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>ir        :call Perl_InsertTemplate("idioms.regex")<CR>
  "
  inoremap    <buffer>  <silent>  <LocalLeader>i$    <C-C>:call Perl_InsertTemplate("idioms.scalar")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>i$=   <C-C>:call Perl_InsertTemplate("idioms.scalar-assign")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>i$$   <C-C>:call Perl_InsertTemplate("idioms.scalar2")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>i@    <C-C>:call Perl_InsertTemplate("idioms.array")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>i@=   <C-C>:call Perl_InsertTemplate("idioms.array-assign")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>i%    <C-C>:call Perl_InsertTemplate("idioms.hash")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>i%=   <C-C>:call Perl_InsertTemplate("idioms.hash-assign")<CR>
  ...
  "
  nnoremap    <buffer>  <silent>  <LocalLeader>ime        :call Perl_InsertTemplate("idioms.method")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>ime   <C-C>:call Perl_InsertTemplate("idioms.method")<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>ime   <C-C>:call Perl_InsertTemplate("idioms.method", "v")<CR>
  "
  nnoremap    <buffer>  <silent>  <LocalLeader>imep        :call Perl_InsertTemplate("idioms.method.private")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>imep   <C-C>:call Perl_InsertTemplate("idioms.method.private")<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>imep   <C-C>:call Perl_InsertTemplate("idioms.method.private", "v")<CR>
  "
  " ----------------------------------------------------------------------------
  " Regex
  " ----------------------------------------------------------------------------
