...
function rainbow_parenthsis#Activate()
    ...
    highlight default level2c  ctermfg=lightblue    guibg=WhiteSmoke   guifg=SeaGreen3
    highlight default level3c  ctermfg=lightgray    guibg=WhiteSmoke   guifg=DarkOrchid3
    highlight default level4c  ctermfg=lightgreen   guibg=WhiteSmoke   guifg=firebrick3
    highlight default level5c  ctermfg=lightcyan    guibg=AntiqueWhite guifg=RoyalBlue3
    highlight default level6c  ctermfg=lightred     guibg=AntiqueWhite guifg=SeaGreen3
    highlight default level7c  ctermfg=lightmagenta guibg=AntiqueWhite guifg=DarkOrchid3
    ...
    highlight default level15c ctermfg=lightred     guibg=AliceBlue    guifg=DarkOrchid3
