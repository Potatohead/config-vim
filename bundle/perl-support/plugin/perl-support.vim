...
let s:Perl_GlobalTemplateFile    = s:plugin_dir.'bundle/perl-support/perl-support/templates/Templates'
let s:Perl_GlobalTemplateDir     = fnamemodify( s:Perl_GlobalTemplateFile, ":p:h" ).'/'
let s:Perl_LocalTemplateFile     = s:Perl_root_dir.'/bundle/perl-support/perl-support/templates/Templates'
...
let s:Perl_Template_Directory    = s:plugin_dir.'bundle/perl-support/perl-support/templates/'
let s:Perl_PerlModuleList        = s:plugin_dir.'bundle/perl-support/perl-support/modules/perl-modules.list'
